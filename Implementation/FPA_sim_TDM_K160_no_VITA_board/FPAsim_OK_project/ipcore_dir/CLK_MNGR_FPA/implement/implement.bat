...
xst -ifn xst.scr
move CLK_MNGR_FPA_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\CLK_MNGR_FPA_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc CLK_MNGR_FPA_exdes.ucf CLK_MNGR_FPA_exdes

echo 'Running map'
map -timing -pr b CLK_MNGR_FPA_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm CLK_MNGR_FPA_exdes -w routed.ncd routed.vhd
cd ..
